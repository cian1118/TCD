...
public class SquareAgesAssignment {
    ...
    public static void main(String[] args) {
        ...
        for (age = 0; age <= MAX_AGE; age++) {
            ageSquared = age * age;
            yearBorn = ageSquared - age;
            currentAge = CURRENT_YEAR - yearBorn;

            if ((currentAge <= MAX_AGE) && (yearBorn <= CURRENT_YEAR)) {
                System.out.println("Born in " + yearBorn + ". Occurs in year " + ageSquared + " when the person is " + age
                        + " years old.");
            }
        }
    }

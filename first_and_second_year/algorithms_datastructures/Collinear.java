...
class Collinear
{
     ...
     *  Order of growth: N^3
     *
     *  Explanation: presence of 3 linear (N) for loops
     */
     ...
     *
     *  Explanation:  insertion sort = N^2, binarySearch = log2N
     *  we multiple orders of growth of the two functions involved in the algorithm.
     *
     *
     */
     ...
     *
     *  Explanation: the search space is halved on each iteration
     *  1 = N/2^x
     *  2^x = N
     *  log2N = x
     *
